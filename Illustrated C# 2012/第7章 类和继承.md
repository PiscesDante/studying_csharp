...
* **标记为public的类可以被系统内任何程序集中的代码访问**。要使一个类对其他程序集可见，使用public访问修饰符：`public class MyClass { ... }`。
...
```C#
abstract public void PrintStuff(string s); // 抽象成员函数
abstract public int MyProperty { set; get; } // 抽象属性
```
